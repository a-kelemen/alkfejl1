...
export const USERS: User[] = [
  ...
  },
  {
    username: "user2", password: "password2", emailAddress: "email2@blahblah.hu", enabled: true,  role: "user", noteGroups: [
      {
        groupId: 1, groupname: "group1", notes: [
          { noteId: 1, noteTitle: "note1", noteText: "blablablablalba", creationTime: new Date("2018-08-15"), importance: 2, isActual: true, labels: [{ labelId: 1, labelText: "label1" }, { labelId: 2, labelText: "label2" }] },
          { noteId: 2, noteTitle: "note2", noteText: "adfhfdhhafhdfha", creationTime: new Date("2018-10-16"), importance: 3, isActual: false, labels: [{ labelId: 1, labelText: "label1" }] }
        ]
      }
    ]
